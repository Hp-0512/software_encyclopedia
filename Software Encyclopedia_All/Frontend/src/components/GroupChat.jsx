...
//     {/* This wrapper handles the 5px gap and the side-by-side layout.
//       CSS 'flex-direction: row-reverse' on '.me' will put the trigger on the left.
//     */}
...
//         autoFocus
//       />
//       <button className="edit-save-btn" onClick={() => saveEdit(msg)}>✔</button>
//     </div>
//   ) : (
...
//               <img src={msg.thumbUrl || msg.fileUrl} alt="uploaded" />
//             </div>
//           )}
...
//               {canEdit && <div onClick={() => startEdit(msg)}>Edit</div>}
//               {isMe && (
//                 <div onClick={() => { setConfirmDelete(msg.id); setDeleteType("everyone"); }}>
//                   Delete for everyone
//                 </div>
//               )}
//               <div onClick={() => { setConfirmDelete(msg.id); setDeleteType("me"); }}>
//                 Delete for me
//               </div>
//             </div>
//           )}
...
//         {/* Selected Reaction Badge (Attached to bubble) */}
//         {reactions[msg.id] && (
...
//       {/* REACTION TRIGGER (The 😊 Button) - Sits outside the bubble */}
//       {hoveredId === msg.id && !msg.deleted && (
//         <div style={{ position: 'relative' }}>
//           <div
//             className="reaction-trigger"
//             onClick={() =>
//               setOpenReactionId(openReactionId === msg.id ? null : msg.id)
//             }
//           >
//             😊
//           </div>
