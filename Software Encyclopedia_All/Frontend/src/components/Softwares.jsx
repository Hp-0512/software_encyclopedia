...
// // // //     if (categoryParam)
// // // //       return String(s.CategoryID) === String(categoryParam);

// // // //     if (searchParam)
// // // //       return s.SoftwareName.toLowerCase().includes(
...
// // // //                 {/* FULL DESC (ON HOVER) */}
// // // //                 <p className="software-desc full">
// // // //                   {s.Description}
// // // //                 </p>
...
// //                   {/* FRONT */}
// //                   <div className="flip-front software-card">
// //                     <div className="software-top">
// //                       <img
// //                         src={s.LogoUrl || "/default.png"}
// //                         alt={s.SoftwareName}
...
// //                   {/* BACK */}
// //                   <div className="flip-back software-card">
// //                     <h4>Description</h4>
...
//     softwares.forEach((s) => {
//       axios
//         .get("http://localhost:5000/api/ratings/average", {
//           params: { softwareName: s.SoftwareName },
//         })
//         .then((res) => {
//           setAvgRatings((prev) => ({
//             ...prev,
//             [s.SoftwareName]: res.data,
//           }));
//         })
//         .catch(() => {});
//     });
...
const Softwares = () => {
  ...
  useEffect(() => {
    ...
    Promise.all(
      softwares.map((s) =>
        axios.get("http://localhost:5000/api/ratings/average", {
          params: { softwareName: s.SoftwareName },
        }),
      ),
    ).then((responses) => {
  ...
  //   const user = auth.currentUser;
  //   if (!user) {
  //     alert("Please login to save software");
  //     return;
  //   }

  //   const saved = getValidSaved(user.uid);
  //   if (saved.some((item) => item.softwareId === s.id)) return;
  ...
  //   setSavedMap((prev) => ({ ...prev, [s.id]: true }));
  // };
