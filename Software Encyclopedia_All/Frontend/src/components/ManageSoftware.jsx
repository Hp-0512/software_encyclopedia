...
const ManageSoftware = () => {
  ...
  useEffect(() => {
    axios
      .get("http://https://software-encyclopedia-2.onrender.com/api/categories")
  ...
  const handleSubmit = (e) => {
    ...
    const request = isEdit
      ? axios.put(
          `http://https://software-encyclopedia-2.onrender.com/api/softwares/${editId}`,
          payload,
        )
      : axios.post(
  ...
  const confirmDelete = () => {
    axios
      .delete(
        `http://https://software-encyclopedia-2.onrender.com/api/softwares/${deleteId}`,
      )
      .then(() => {
        fetchSoftwares();
        setDeleteId(null);
