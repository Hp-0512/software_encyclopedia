...
// import heroImage from "../assets/login_signup_i2.jpg";
...
import hero1 from "../assets/login_signup_i1.png";
import hero2 from "../assets/login_signup_i2.jpg";
import hero3 from "../assets/login_signup_i3.jpg";
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            {submitMessage && (
              <p className="submit-message error-strong">
                {submitMessage}
              </p>
            )}
